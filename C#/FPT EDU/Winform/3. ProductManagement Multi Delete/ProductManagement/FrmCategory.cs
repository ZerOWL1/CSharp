...
namespace ProductManagement
{
    public partial class FrmCategory : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            DataTable checkID = Categories.getCategoryByID(id);
            ...
            if (statusAdd == true)
            {
                ...
                if (Validate())
                {
                    ...
                    {
                        MessageBox.Show("Invalid Data Input or You've input exist Data", "Warning", MessageBoxButtons.OK,
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (m == DialogResult.OK)
            {
                ...
                {
                    //Bool return true or false when Options Selected
                    bool selected = Convert.ToBoolean(r.Cells[0].Value);
                    if (selected)
                    {
                        //Add Value ID at 1 into Cell
                        list.Add(Convert.ToString(r.Cells[1].Value));
                    }
                }
                //Delete Func
                Categories.DeleteListCateByID(list);
                //Show Value after delete
                dgvCategory.DataSource = Categories.GetCategories();
                txtCatId.Text = String.Empty;
                txtCatName.Text = String.Empty;
                txtDescription.Text = String.Empty;
